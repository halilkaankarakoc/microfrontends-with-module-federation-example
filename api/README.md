...
```
$ curl http://localhost:3006/placeholder.txt
...
```
$ curl http://localhost:3006/unauthorized
$ # result -> true
```
...
```
$ curl http://localhost:3006/authorized
...
```
$ # POST /auth/login
$ curl -X POST http://localhost:3006/auth/login -d '{"username": "maria", "password": "123"}' -H "Content-Type: application/json"
...
$ curl http://localhost:3006/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
